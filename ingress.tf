...
data "openstack_networking_port_v2" "ingress-port" {
  device_id  = openstack_compute_instance_v2.ingress.id
  network_id = "35fe8b76-cc31-4b48-b3f0-5c48eef8d289"
}

resource "openstack_networking_floatingip_associate_v2" "ingressIP" {
  floating_ip = openstack_networking_floatingip_v2.floatip_1.address
  port_id     = data.openstack_networking_port_v2.ingress-port.id
}
